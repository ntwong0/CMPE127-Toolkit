...
set rc [catch {
  ...
  add_files -quiet /home/kammce/Documents/University/CMPE127/CMPE127-Toolkit/CMPE127-Toolkit.runs/synth_1/Motherboard.dcp
  read_xdc /home/kammce/Documents/University/CMPE127/CMPE127-Toolkit/CMPE127-Toolkit.srcs/constrs_1/new/Motherboard.xdc
  link_design -top Motherboard -part xc7a50tcsg324-1
...
set rc [catch {
  ...
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -file Motherboard_control_sets_placed.rpt"
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -file Motherboard_timing_summary_routed.rpt -warn_on_violation  -rpx Motherboard_timing_summary_routed.rpx"
