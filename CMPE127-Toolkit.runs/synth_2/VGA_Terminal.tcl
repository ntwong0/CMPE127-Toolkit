...
set_property used_in_implementation false [get_files /home/kammce/Documents/University/CMPE127/CMPE127-Toolkit/CMPE127-Toolkit.srcs/constrs_1/new/Motherboard.xdc]


synth_design -top VGA_Terminal -part xc7a100tcsg324-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef VGA_Terminal.dcp
create_report "synth_2_synth_report_utilization_0" "report_utilization -file VGA_Terminal_utilization_synth.rpt -pb VGA_Terminal_utilization_synth.pb"
