...
set rc [catch {
  ...
  add_files -quiet /home/kammce/Documents/University/CMPE127/CMPE127-Toolkit/CMPE127-Toolkit.runs/synth_2/Keyboard_DEMO.dcp
  ...
  link_design -top Keyboard_DEMO -part xc7a100tcsg324-1
...
set rc [catch {
  ...
  catch { write_mem_info -force Keyboard_DEMO.mmi }
